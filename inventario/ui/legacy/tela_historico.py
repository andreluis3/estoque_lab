...
class TelaHistorico(QDialog):
    ...
    def _carregar_tudo(self):
        ...
        movs  = self.crud.listar_movimentacoes(item_id=item_id, tipo=tipo, usuario=usuario)
        hists = self.crud.listar_historico(item_id=item_id, usuario=usuario)
